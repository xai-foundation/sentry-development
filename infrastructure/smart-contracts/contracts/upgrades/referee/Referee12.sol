...
contract Referee12 is Initializable, AccessControlEnumerableUpgradeable {
    ...
    function initialize() public reinitializer(7) {
        ...
        stakeAmountTierThresholds[1] = 300_000 * 10 ** 18;
        stakeAmountTierThresholds[2] = 4_000_000 * 10 ** 18;
        stakeAmountTierThresholds[3] = 15_000_000 * 10 ** 18;
