...
contract Referee15 is Initializable, AccessControlEnumerableUpgradeable {
    ...
    function initialize() public reinitializer(9) {
        ...
        stakeAmountTierThresholds[0] = 3_000 * 10 ** 18;
        stakeAmountTierThresholds[1] = 30_000 * 10 ** 18;
        stakeAmountTierThresholds[2] = 400_000 * 10 ** 18;
        stakeAmountTierThresholds[3] = 1_500_000 * 10 ** 18;
