...
contract Referee16 is Initializable, AccessControlEnumerableUpgradeable {
    ...
    //     maxStakeAmountPerLicense = 2000 * 10 ** 18;
    //     maxKeysPerPool = 100_00;
    // }
    ...
    function getBoostFactorForStaker(address staker) external view returns (uint256) {
        ...
        if(PoolFactory10(poolFactoryAddress).poolsCreatedViaFactory(staker)){
    ...
    */
    function submitPoolAssertion(address _poolAddress, uint256 _challengeId, bytes memory _confirmData) external {
        ...
        require(PoolFactory10(poolFactoryAddress).validateSubmitPoolAssertion(_poolAddress, msg.sender), "17");
