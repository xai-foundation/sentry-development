...
contract Referee13 is Initializable, AccessControlEnumerableUpgradeable {
    ...
    function initialize() public reinitializer(8) {
        ...
        stakeAmountTierThresholds[0] = 3_000_000 * 10 ** 18;
        stakeAmountTierThresholds[1] = 30_000_000 * 10 ** 18;
        stakeAmountTierThresholds[2] = 400_000_000 * 10 ** 18;
        stakeAmountTierThresholds[3] = 1_500_000_000 * 10 ** 18;
