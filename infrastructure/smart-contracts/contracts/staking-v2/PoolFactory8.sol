...
contract PoolFactory8 is Initializable, AccessControlEnumerableUpgradeable {
    ...
    function initialize(
        ...
        updateRewardBreakdownDelayPeriod = 4 minutes + 30;
    }
    ...
    function createUnstakeKeyRequest(address pool, uint256 keyAmount) external {
        ...
        StakingPool5(pool).createUnstakeKeyRequest(msg.sender, keyAmount, unstakeKeysDelayPeriod);
    ...
    function createUnstakeOwnerLastKeyRequest(address pool) external {
        ...
        StakingPool5(pool).createUnstakeOwnerLastKeyRequest(msg.sender, unstakeGenesisKeyDelayPeriod);
    ...
    function createUnstakeEsXaiRequest(address pool, uint256 amount) external {
        ...
        StakingPool5(pool).createUnstakeEsXaiRequest(msg.sender, amount, unstakeEsXaiDelayPeriod);
    ...
    function isDelegateOfPoolOrOwner(
		...
		StakingPool5(pool).getPoolOwner() == delegate;
    }
