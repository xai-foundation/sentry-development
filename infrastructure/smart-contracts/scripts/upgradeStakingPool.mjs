...
const currentContractImplementationName = "StakingPool4";                //TODO Update to valid values
const newContractImplementationName = "StakingPool5";                   //TODO Update to valid values
